...
<R#读出内容BlockName留言 start#>
    <form class="comment" name="formcomment" method="post" action="[$WEB_VIEWURL$]?act=savedata&stype=guestbook&itemid=[$glb_Id$]" target="_blank" onSubmit="return formSubmit()">
