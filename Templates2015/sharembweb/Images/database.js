...
function getConfig(){
    ...
    c+="\n";
    c+="ASPPHP\n";
    c+="	ColumnList (columnname|topnumb|default-[$栏目导航列表$]|flags-top|addsql-order by sortrank|testspan-1|inmodule)\n";
    ...
    c+="	GetOnePageBody (id|title|fieldname-aboutcontent|len|addsql|delhtml--checkbox|trim--checkbox|autoadd|testspan-1|default|inmodule\n";
    ...
    c+="\n";
    c+="[$栏目无级菜单列表$] start\n";
    c+="[list]<li><a href=\"[$url$]\" title=\"[$title$]\"[$atarget$][$abcolor$]>[$columnname$]</a></li>[/list] \n";
    c+="[list-focus]<li><a href=\"[$url$]\" title=\"[$title$]\"[$atarget$][$abcolor$]><font color=red>[$columnname$]</font></a></li>[/list-focus]\n";
    c+="\n";
